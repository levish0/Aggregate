...
inspection-country = 국가
inspection-state = 주
inspection-overview = 개요
inspection-buildings = 건물
inspection-population = 인구
inspection-territory = 영토
inspection-programs = 프로그램
inspection-provinces = 프로빈스
inspection-states = 주
inspection-workforce = 노동 인구
inspection-construction = 건설 대기열
inspection-region-owners = 같은 지역을 나누어 가진 국가
inspection-remaining-work = 남은 작업량
inspection-no-program-data = 현재 선택에 정보를 제공하는 활성 프로그램이 없습니다.
...
simulation-processing = 계산 중…
inspection-building-level = { $level }단계
inspection-expand = + 증설
inspection-material-shortage = 건설 자재 부족
inspection-queue-empty = 진행 중인 건설이 없습니다.
inspection-progress = 진행률
map-nav-construction = 건설
list-previous = 이전
list-next = 다음
setup-world-title = 게임 설정
setup-world-description = 시작 국가와 활성 프로그램을 선택하세요.
setup-world-building = 세계를 준비하고 있습니다…
setup-country = 시작 국가
...
inspection-build-site = 자원과 노동력을 고려해 이 영역 안에서 건설할 지역을 선택합니다.
inspection-project-progress = 잔여 작업 { $work } · 노동자 { $active } / { $requested }
map-news-title = 소식
map-news-empty = 아직 새로운 소식이 없습니다.
program-health-title = 공중 보건
