fleet_entity_key = {
	...
	# [Optional] The flagship decoration entity to be attached to the flagship's base ship entity (toggleable)
	flagship_decoration_entity = <flagship_decoration_entity_name>
